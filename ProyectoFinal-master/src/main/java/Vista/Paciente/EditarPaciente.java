...
public class EditarPaciente extends javax.swing.JInternalFrame {
    ...
    private String cedulaAnterior; // Almacena la cédula del paciente que se está editando
    public EditarPaciente(JDesktopPane desktopPane, String cedula, String nombre, int edad, String sexo) {
    ...
    boolean actualizado = pacienteControlador.actualizarPaciente(cedulaAnterior, cedula, nombre, edad, sexo);
